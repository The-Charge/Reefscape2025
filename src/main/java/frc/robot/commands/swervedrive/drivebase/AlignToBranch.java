...
public class AlignToBranch extends Command {
  ...
  public AlignToBranch(
      SwerveSubsystem swerveSub, HeadSubsystem headSub, ElevSubsystem elevSub, boolean rightBool) {
    swerve = swerveSub;
    head = headSub;
    elev = elevSub;
    right = rightBool;
  ...
  public void execute() {
    swerve.drive(
        new Translation2d(0, SwerveConstants.branchAlignSpeed * (right ? -1 : 1)), 0, false);
  }
