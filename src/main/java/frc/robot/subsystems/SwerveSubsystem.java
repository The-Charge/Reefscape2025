...
public class SwerveSubsystem extends SubsystemBase {
  ...
  public SwerveSubsystem(File directory) {
    ...
    swerveDrive.setCosineCompensator(
        SwerveConstants.useCosineCompensator
    ...
    swerveDrive.setAngularVelocityCompensation(
        ...
        SwerveConstants
            .angularCompensation); // Correct for skew that gets worse as angular velocity
  ...
  public void periodic() {
    ...
    else LoggingManager.logAndAutoSendValue("Swerve RunningCommand", getCurrentCommand().getName());
  ...
  //                                                             .getYaw()))); // Not sure if this
  // will work, more math may be required.
  //        }
  //      }
  //    });
  //  }
  ...
  public Pose2d getClosestReefTagPose() {
    ...
    for (int i = 1; i <= 22; i++) {
      if (i == 4 || i == 5 || i == 14 || i == 15 || i == 3 || i == 16 || i == 1 || i == 2 || i == 12
          || i == 13) continue;
  ...
  public Pose2d getClosestTagPose() { // Ignores barge and processor
    final List<Pose2d> tagPoses = new ArrayList<>();
    for (int i = 1; i <= 22; i++) {
      if (i == 4 || i == 5 || i == 14 || i == 15 || i == 3 || i == 16) continue;
      tagPoses.add(ApriltagConstants.TAG_POSES[i].toPose2d());
    }
    return swerveDrive.getPose().nearest(tagPoses);
  }
