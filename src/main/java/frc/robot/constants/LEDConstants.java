...
public abstract class LEDConstants {
  ...
  public static final int[] brokenIndicies = new int[] {ledLength - 12 * 3 + 1};
  ...
  public static final double endgameDisplayTime =
      30; // amount of time the endgame pattern is displayed for
  public static final double endgameRumbleTime = 2; // amount of time the controllers rumble for

  public static final List<ElevSubsystem.Level> branchAlignLevels =
      List.of(ElevSubsystem.Level.LVL2, ElevSubsystem.Level.LVL3, ElevSubsystem.Level.LVL4);
}
